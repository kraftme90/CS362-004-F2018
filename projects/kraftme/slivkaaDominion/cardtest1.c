...
int main ()	{
	...
	G.deck[opponent][G.deckCount[opponent]-4] = gold;
	G.deck[opponent][G.deckCount[opponent]-5] = copper;
	...
	G.deck[currentPlayer][G.deckCount[currentPlayer]-4] = gold;
	G.deck[currentPlayer][G.deckCount[currentPlayer]-5] = copper;
